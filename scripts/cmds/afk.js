...
module.exports = {
  ...
  onStart: async function ({ message, event, args }) {
    ...
    return message.reply(`You have enabled AFK mode. Reason: ${reason}`);
  },
  ...
  onChat: async function ({ message, event, usersData }) {
    ...
    if (userAfk) {
      ...
      msg += `Have ${userAfk.mentions.length} the person who tagged you while you were AFK:\n\n`;
